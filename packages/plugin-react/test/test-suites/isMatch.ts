  ...
  engine.describe('The isMatch plugin', () => {
    engine.test(
      ...
      ({ EnumPlus: { Enum }, WeekConfig: { StandardWeekConfig }, i18n: { enUS } }) => {
        ...
        const weekWithBadItemEnum = Enum({
          ...StandardWeekConfig,
          Bad: { value: 8 } as { value: 8; label: never },
          Terrible: undefined!,
        });
    ...
    engine.test(
      ...
      ({ EnumPlus: { Enum }, WeekConfig: { StandardWeekConfig }, i18n: { zhCN } }) => {
        ...
        return { locales: zhCN, findBy_Mon, findBy_Mon_CaseSensitive };
      },
    ...
    engine.test(
      ...
      ({ EnumPlus: { Enum }, WeekConfig: { StandardWeekConfig }, i18n: { enUS } }) => {
        ...
        return { locales: enUS, findBy_2, findBy_2_CaseSensitive };
      },
    ...
    engine.test(
      ...
      ({ EnumPlus: { Enum }, WeekConfig: { StandardWeekConfig }, i18n: { enUS } }) => {
        ...
        return { locales: enUS, findByRaw, findByRawCaseSensitive };
      },
    ...
    engine.test(
      ...
      ({ EnumPlus: { Enum }, WeekConfig: { StandardWeekConfig }, i18n: { enUS, neutral } }) => {
        ...
        const switchMondayTuesday = (key: string | undefined) => {
          const localeKey = Object.keys(neutral).find((k) => neutral[k as keyof typeof neutral] === key);
          if (key === 'weekday.monday') return enUS['weekday.Tuesday'];
          else if (key === 'weekday.tuesday') return enUS['weekday.Monday'];
          else return enUS[localeKey as keyof typeof enUS];
        };
        ...
        return { locales: enUS, matchTue, matchTueCaseSensitive };
      },
