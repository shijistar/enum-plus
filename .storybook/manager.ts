...
/**
 * - done: why use enum-plus的demo说的太简单了
 * - done: 两种vue的组件 output里都写着[ReactElement]？
 * - cancel: 能否通过mock模块让next-international跑起来，或者仅在示例代码或文案中使用此插件，但底层还是基于react插件
 ...
 * - todo: 所有插件支持自动刷新，可以在外层包一个Context，实现全局刷新
