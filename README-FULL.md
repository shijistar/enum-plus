...
> You can also download these files from the [GitHub Releases](https://github.com/shijistar/enum-plus/releases/tag/v3.2.1).
...
<sup>**_\[F]_**</sup> &nbsp; `item(keyOrValue?: string | number): EnumItemClass | undefined`
