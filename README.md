...
- Fully compatible with native `enum` usage, making it a drop-in replacement for native `enum`
...
- Supports localization, can use any internationalization library
